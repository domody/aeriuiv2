...
Before adding aeriui components, you’ll need to set up your project to work with aeriui system. This page will cover the setup steps, including creating a `cn` function, adding the required `css` styles, and configuring the `aeriui.json` file. The setup process has been made simple through the CLI, which will handle most of the work for you.
